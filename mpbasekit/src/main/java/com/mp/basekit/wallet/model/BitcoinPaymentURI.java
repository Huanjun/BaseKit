package com.mp.basekit.wallet.model;
...
public class BitcoinPaymentURI {
    ...
    public String getAmount() {
        ...
        return parameters.get(PARAMETER_AMOUNT).getValue();
    }

    public String getToken() {
        HashMap<String, Parameter> map = getParameters();
        Parameter parameter = map.get("tokenName");
        String token = "BTC";
        if (parameter != null) {
    ...
    public static BitcoinPaymentURI parse(String string) {
        ...
        if (queryParametersFiltered.containsKey(PARAMETER_AMOUNT)) {
            bitcoinPaymentURIBuilder.amount(queryParametersFiltered.get(PARAMETER_AMOUNT));
