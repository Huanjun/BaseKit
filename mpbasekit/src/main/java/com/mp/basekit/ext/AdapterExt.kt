...
fun BaseQuickAdapter<*, *>.loadMoreError() {
...
fun BaseQuickAdapter<*, *>.loadMoreEnd() {
    loadMoreModule.loadMoreEnd()
}

fun BaseQuickAdapter<*, *>.loadMoreFinish(isLastPage: Boolean, isNoMoreGone: Boolean = false) {
    if (isLastPage)
        loadMoreModule.loadMoreEnd(isNoMoreGone && itemCount < 10)
    else
        loadMoreModule.loadMoreComplete()
}