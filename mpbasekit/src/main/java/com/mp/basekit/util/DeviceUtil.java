...
public class DeviceUtil {
     ...
     * @return
     */
    public static String getDeviceIdA(Context context) {
        return String.format("%s%s", "A", getDeviceId(context));
    }
...
//        }
    ...
    private static String readDeviceID(Context context) {
        return (String) SPUtil.get(context, DEVICES_FILE_NAME, "");
    }
    ...
    private static void saveDeviceID(String str, Context context) {
        SPUtil.put(context, DEVICES_FILE_NAME, str);
    }
