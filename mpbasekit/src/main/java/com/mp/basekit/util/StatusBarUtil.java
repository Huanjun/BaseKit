...
public class StatusBarUtil {
    ...
    /**
     * ic_mine_setting DrawerLayout 属性
     *
     * @param drawerLayout              DrawerLayout
    ...
    public static void setTranslucentForImageView(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha,
        ...
        if (needOffsetView != null) {
            ...
            needOffsetView.setVisibility(View.VISIBLE);
        }
    }
    ...
    public static void setLightMode(Activity activity) {
        boolean isMIUIDark = setMIUIStatusBarDarkIcon(activity, true);
        boolean isMeizuDark = setMeizuStatusBarDarkIcon(activity, true);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR| View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
        } else {
            if (!isMeizuDark && !isMIUIDark) {
                setColor(activity, activity.getResources().getColor(R.color.color_status_gray), 0);
            }
        }
    ...
    public static void setStatusViewHeight(Context context, View statusView) {
        ViewGroup.LayoutParams lp = statusView.getLayoutParams();
        lp.height = getStatusBarHeight(context);
        statusView.setLayoutParams(lp);
    }

    public static void setStatusHeightMargin(Context context, View statusView) {
        ViewGroup.MarginLayoutParams lp = (ViewGroup.MarginLayoutParams) statusView.getLayoutParams();
