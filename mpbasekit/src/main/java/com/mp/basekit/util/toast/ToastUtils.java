...
public final class ToastUtils {
    ...
    public static void init(Application application) {
        ...
        if (sDefaultStyle == null) {
            // 如果样式没有指定就初始化一个默认的样式
            initStyle(new ToastAntpoolStyle());
        }
    ...
    private static void checkToastState() {
        ...
        if (sToast == null) {
            init(MPApplication.getApplication());
//            throw new IllegalStateException("ToastUtils has not been initialized");
    ...
    private static View createTextView(Context context) {
        ...
        toastLayout.setPadding((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, sDefaultStyle.getPaddingLeft(), context.getResources().getDisplayMetrics()),
