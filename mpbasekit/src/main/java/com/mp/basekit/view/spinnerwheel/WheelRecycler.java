...
public class WheelRecycler {
     ...
     * @param firstItem the phoneNumber of first item in layout
     * @param range the range of current spinnerwheel items
     * @return the new value of first item phoneNumber
     */
    ...
    /**
     * Adds view to cache. Determines view callType (item view or empty one) by index.
     * @param view the view to be cached
