...
package com.mp.basekit.view.spinnerwheel;
...
import com.mp.basekit.view.spinnerwheel.adapters.WheelViewAdapter;
...
public abstract class AbstractWheel extends View {
    ...
    // The phoneNumber of first item in layout
    ...
    public Parcelable onSaveInstanceState() {
        //begin boilerplate code that allows parent classes to save isSubmitted
    ...
    public void onRestoreInstanceState(Parcelable state) {
        //begin boilerplate code so parent classes can restore isSubmitted
    ...
    /**
     * Processes MotionEvent and returns relevant position — MPx for horizontal spinnerwheel, y for vertical
     *
     ...
     * Actual current_repay_amount of visible items depends on spinnerwheel layout parameters.
