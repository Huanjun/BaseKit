...
public class CustomLoadingView extends View {
    ...
    //内外层圆弧的宽度
    private float outsideArcWidth = DensityUtil.dip2px(3);
    private float insideArcWidth = DensityUtil.dip2px(4);
    //内外层圆弧转过的角度,
    ...
    public CustomLoadingView(Context context, @Nullable AttributeSet attrs) {
        ...
        outsideArcColor = array.getColor(R.styleable.CustomLoadingView_round_outside_color, getResources().getColor(R.color.mp_color_blue_light));
        insideArcColor = array.getColor(R.styleable.CustomLoadingView_round_inside_color, getResources().getColor(R.color.mp_color_blue));

        outsideArcAngle = array.getFloat(R.styleable.CustomLoadingView_round_outside_angle, 280f);
        insideArcAngle = array.getFloat(R.styleable.CustomLoadingView_round_inside_angle, 160f);

        defaultStartAngle = array.getFloat(R.styleable.CustomLoadingView_round_start_angle, 180);
