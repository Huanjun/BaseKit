package com.mp.basekit.view.magicindicator.buildins.circlenavigator;
...
public class CircleNavigator extends View implements IPagerNavigator {
    ...
    private int mCircleCommonColor;
    ...
    private void drawCircles(Canvas canvas) {
        mPaint.setColor(mCircleCommonColor);
    ...
    public int getCircleCommonColor() {
        return mCircleCommonColor;
    }

    public void setCircleCommonColor(int circleColor) {
        mCircleCommonColor = circleColor;
        invalidate();
    }
